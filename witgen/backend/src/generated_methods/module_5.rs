...
fn method_0(
    ...
    let v4: typed::NatField<2> = typed::NatField::<2>(v3.clone());
    Ok(v4.clone())
}
...
fn decode_0(value: &serde_json::Value) -> witgen_native::Result<typed::NatField<2>> {
    Ok(typed::parse_nat_field::<2>(value)?)
}

fn encode_0(value: typed::NatField<2>) -> serde_json::Value {
